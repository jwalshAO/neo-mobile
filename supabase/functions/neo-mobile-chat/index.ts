...
const WHISPER_PROMPT = "Field intelligence and CRM queries for Agility Orthopaedic, an upper-extremity orthopedic distributor in PA and NJ. Manufacturers we sell: Skeletal Dynamics, Orthocell, TYBR Health, Insight Surgery, Enovis DJO, Virak Ortho, Simparo Surgical, Captiox, FX Shoulder. Orthocell products include Remplir and Striate. Competitors: Acumed, DePuy Synthes, Stryker, Arthrex, Axogen, Zimmer Biomet, TriMed, Avanti, Smith and Nephew, Integra, Medartis, Biederman, AM Surgical, Globus Medical. Hospitals and surgery centers: Lehigh Valley, Einstein, Methodist, King of Prussia, Penn Presbyterian, York, Wellspan, Bryn Mawr, Lankenau, Coordinated Health, Jefferson, Turk's Head, Holy Redeemer, Temple, Abington, Chester County, Hershey, Lancaster General, Penn State Hershey, Phoenixville, St. Luke's. Procedures: distal radius, scaphoid, carpal tunnel, tendon transfer, cubital tunnel, trigger finger, ulnar nerve, elbow, shoulder. Surgeons we cover: Sibley, Trevino, Angeles, Liu, Lee, Gonzalez, Kish, Corum, Jones, Williamson, Rosenfeld, Zelouf, Andrews, Razavi, Muetterties, Payatakes, Elliott, Wessel, Donegan, Lin, Mayberry, Dobrowolski, Dailey, Knoedler, Pinkowski, Petrucelli.";
